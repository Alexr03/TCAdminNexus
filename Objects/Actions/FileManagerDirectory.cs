...
namespace TCAdminNexus.Objects.Actions
{
    public class FileManagerDirectory
    {
        ...
        public async System.Threading.Tasks.Task CreateFile()
        {
        ...
        public async System.Threading.Tasks.Task DeleteDirectory()
        {
        ...
        public async System.Threading.Tasks.Task UploadFile()
        {
            var interactivity = CommandContext.Client.GetInteractivity();
