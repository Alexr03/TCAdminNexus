...
namespace TCAdminNexus.Objects.Emulators
{
    public class TcaTaskManager
    {
        ...
        {
            Task = new TCAdmin.TaskScheduler.SDK.Objects.Task(taskId);

            TaskMessage = statusMessage;
        }

        public TCAdmin.TaskScheduler.SDK.Objects.Task Task { get; private set; }
        ...
        {
            Task = new TCAdmin.TaskScheduler.SDK.Objects.Task(Task.TaskId);
