...
using TCAdminNexus.Objects.Actions;
...
namespace TCAdminNexus.Objects.FileSystem
{
    public class FileSystemUtilities
    {
        ...
        private async System.Threading.Tasks.Task CopyFile(FileInfo file)
        {
        ...
        private async System.Threading.Tasks.Task DeleteFile(FileInfo file)
        {
        ...
        private async System.Threading.Tasks.Task EditFile(FileInfo file)
        {
            var interactivity = CommandContext.Client.GetInteractivity();
            await DownloadFile(file);
        ...
        private async System.Threading.Tasks.Task ExtractFile(FileInfo file)
        {
            try
            {
        ...
        private async System.Threading.Tasks.Task RenameFile(FileInfo file)
        {
            var interactivity = CommandContext.Client.GetInteractivity();
        ...
        private async System.Threading.Tasks.Task CleanUp(DiscordChannel channel, DiscordMessage afterMessage)
        {
