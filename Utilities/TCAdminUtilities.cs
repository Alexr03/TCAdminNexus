...
namespace TCAdminNexus.Utilities
{
    public static class TcAdminUtilities
    {
        ...
        public static async System.Threading.Tasks.Task SendGraph(CommandContext ctx, Service service, ServiceChartType chartType)
        {
